...
const remoteExams = [
  ...
  { path: "https://www.jlptpracticetest.com/api/test/n1/202212", id: "exam-2022-12", title: "2022 tháng 12" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/202207", id: "exam-2022-07", title: "2022 tháng 7" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/202112", id: "exam-2021-12", title: "2021 tháng 12" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/202107", id: "exam-2021-07", title: "2021 tháng 7" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/202012", id: "exam-2020-12", title: "2020 tháng 12" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/201912", id: "exam-2019-12", title: "2019 tháng 12" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/201907", id: "exam-2019-07", title: "2019 tháng 7" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/201812", id: "exam-2018-12", title: "2018 tháng 12" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/201807", id: "exam-2018-07", title: "2018 tháng 7" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/201712", id: "exam-2017-12", title: "2017 tháng 12" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/201707", id: "exam-2017-07", title: "2017 tháng 7" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/201612", id: "exam-2016-12", title: "2016 tháng 12" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/201607", id: "exam-2016-07", title: "2016 tháng 7" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/201512", id: "exam-2015-12", title: "2015 tháng 12" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/201507", id: "exam-2015-07", title: "2015 tháng 7" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/201412", id: "exam-2014-12", title: "2014 tháng 12" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/201407", id: "exam-2014-07", title: "2014 tháng 7" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/201312", id: "exam-2013-12", title: "2013 tháng 12" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/201307", id: "exam-2013-07", title: "2013 tháng 7" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/201212", id: "exam-2012-12", title: "2012 tháng 12" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/201207", id: "exam-2012-07", title: "2012 tháng 7" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/201112", id: "exam-2011-12", title: "2011 tháng 12" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/201107", id: "exam-2011-07", title: "2011 tháng 7" },
  { path: "https://www.jlptpracticetest.com/api/test/n1/201012", id: "exam-2010-12", title: "2010 tháng 12" },
];
...
function explanationForRemoteQuestion(exam, item, group) {
  ...
  if (questionNumber <= 6) {
    return `Đáp án: ${item.correctAnswer}. Cách đọc đúng trong câu là 「${correctText}」. Đây là dạng kiểm tra âm đọc kanji, nên hãy gắn cách đọc với cả cụm trong đề: ${prompt}`;
  }

  if (questionNumber <= 13) {
    return `Đáp án: ${item.correctAnswer}. Chỗ trống cần 「${correctText}」 để câu tự nhiên về nghĩa và cách kết hợp từ. Đặt vào câu sẽ thành: ${prompt.replace("（　）", `「${correctText}」`)}`;
  }

  if (questionNumber <= 19) {
    return `Đáp án: ${item.correctAnswer}. Trong ngữ cảnh này, từ/cụm được hỏi gần nghĩa nhất với 「${correctText}」. Các lựa chọn còn lại lệch sắc thái hoặc không khớp với ý của câu.`;
  }

  if (questionNumber <= 25) {
    return `Đáp án: ${item.correctAnswer}. Cách dùng đúng là câu có 「${correctText}」. Từ được hỏi phải đi với danh từ/động từ và tình huống tự nhiên như trong lựa chọn này; các câu khác dùng sai quan hệ nghĩa hoặc collocation.`;
  }

  if (questionNumber <= 35) {
    return `Đáp án: ${item.correctAnswer}. Mẫu đúng là 「${correctText}」. Khi đặt vào câu, cấu trúc ngữ pháp và sắc thái câu sẽ khớp nhất: ${prompt.replace("（　）", `「${correctText}」`)}`;
  }

  if (questionNumber <= 40) {
    return `Đáp án: ${item.correctAnswer}. Đây là bài sắp xếp câu có dấu ★. Hãy ghép các mảnh theo trật tự tự nhiên của tiếng Nhật, rồi lấy mảnh nằm ở vị trí ★; mảnh đúng là 「${correctText}」.`;
  }

  if (questionNumber <= 44) {
    return `Đáp án: ${item.correctAnswer}. Trong đoạn văn, chỗ này cần 「${correctText}」 để nối đúng mạch ý trước sau. Khi làm dạng này, ưu tiên quan hệ logic trong đoạn hơn là chỉ nhìn riêng một câu.`;
  }

  return `Đáp án: ${item.correctAnswer}. Theo nội dung đoạn đọc, lựa chọn đúng là 「${correctText}」. Đáp án này khớp trực tiếp với ý chính/chi tiết trong bài, còn các lựa chọn khác thường sai do nói quá, đổi chủ thể hoặc lệch điều kiện.`;
}
